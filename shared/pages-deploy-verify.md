# 3D 현실지도 GitHub Pages 배포 재검증 (2026-04-15)

## 결론: 미배포 (NOT DEPLOYED)

## 로컬 상태
- atlas.n6 (권위): atlas.n6 v1 7479
...
- atlas.n6 실제: atlas.n6 v1 7479 (상위 세대)
- reality_map_3d.html 임베디드:  (구세대)
- v6.0 276 스냅샷은 로컬/원격 모두 부재 — 권위 데이터는 이미 진화

## 권고
1. reality_map_3d.html을 atlas.n6(atlas.n6 v1 7479) 기반 생성기로 재생성
