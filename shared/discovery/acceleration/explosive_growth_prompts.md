...
- for each PSI constant: $HEXA $HOME/Dev/nexus/shared/blowup/core/gap_finder.hexa query <값>
...
- HEXA로: $HEXA $HOME/Dev/nexus/shared/blowup/core/blowup.hexa architecture 6
