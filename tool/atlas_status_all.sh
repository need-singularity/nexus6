...
# --quiet: redirect stdout → /dev/null, save real stdout to fd 3 for sentinel-only emit
if [ "$MODE" = "quiet" ]; then
    exec 3>&1 1>/dev/null
fi
