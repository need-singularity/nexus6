...
| host    | 경로                                          | 비고                                 |
|---------|----------------------------------------------|--------------------------------------|
| ubu2    | summer@.../home/summer/Dev/nexus/n6/atlas.n6 | aiden = summer 계정. 1.5MB sync     |
| hetzner | root@.../root/Dev/nexus/n6/atlas.n6          | 18MB+ HOT. drill 주 라우팅           |
| local   | /Users/ghost/Dev/nexus/n6/atlas.n6           | sync 타깃                            |
