...
ref:
  ...
  cli_bake  hexa-lang self/main.hexa @cli bake   `hexa smash|free|absolute|drill|thinking|lens|atlas|bus|roadmap|discovery|status-proj|roadmap-proj|convergence-proj` = nexus-cli passthrough (전 프로젝트 cwd 동작, 53ef97a1)
                                                  drill (2026-04-19 Mk.VIII): smash→free→absolute 사슬 고갈까지 단일 명령어 (nexus.hexa)
