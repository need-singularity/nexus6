...
- **atlas_health.sh** — `shared/n6/atlas_health.sh [path] [--verbose]` : orphan refs / dup / malformed / grade 분포 readonly 헬스체크
...
| `shared/n6/atlas_health.sh` | atlas.n6 readonly 헬스체크 (orphan/dup/malformed/grade) |
