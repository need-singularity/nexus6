...
- **n6-arch [11*REPO_INVARIANT]**: N6HIST-A-CORE-IDENTITY ([11*REPO_INVARIANT]) and N6HIST-A-RIDENTITY ([11*]) are the most authoritative encodings of the n=6 master identity, sitting in atlas.append.CANON-historical-from-nexus-2026-04-26.n6 — these and F90 form a 3-witness chain (hexa-lang shard + n6-arch CORE + n6-arch R-IDENTITY) that should ideally have parallel falsifiers.
